        ...
        private bool TryGetScriptError(Exception exception, out IScriptEngineException scriptError)
        {
            ...
            if (comException != null)
            {
                ...
                else if (RawCOMHelpers.HResult.GetFacility(result) == RawCOMHelpers.HResult.FACILITY_CONTROL)
                {
                    ...
                    {
                        scriptError = new ScriptEngineException(engine.Name, runtimeErrorMessage, null, RawCOMHelpers.HResult.CLEARSCRIPT_E_SCRIPTITEMEXCEPTION, false, exception.InnerException,null);
                        return true;
                    }
                    ...
                    {
                        scriptError = new ScriptEngineException(engine.Name, syntaxErrorMessage, null, RawCOMHelpers.HResult.CLEARSCRIPT_E_SCRIPTITEMEXCEPTION, false, exception.InnerException, null);
                        return true;
                    }
                }
